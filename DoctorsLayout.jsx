        ...
        <section className='   flex flex-col p-[27px] border-black max-w-[330px] w-full leading-20'>
              ...
              >
               {" "}
                <Icon
                  ...
                  className={({ isActive }) =>
                    " w-[24px] h-[24px]    " +
                    (isActive ? "text-[#2C26DB]" : 'text-red-400' )
                  }
                />{" "}
              <span className="text-[#84828A] text-[15px] ">Department Management</span>  
              </NavLink>
              <NavLink
                to={"/doctorsstaff"}
                className={({ isActive }) =>
          ...
          {" "}
                <Icon
                  icon={"ion:people"}
                  className={({ isActive }) =>
                    " w-[24px] h-[24px]  text-[#84828A]  " +
                    (isActive ? "bg-red-500" : " ")
                  }
                />{" "}
               <span className="text-[#84828A]">Staff Management</span> 
              </NavLink>
              <NavLink
                to={"/DoctorsPatient"}
                className={({ isActive }) =>
            ...
            >
                ...
                {" "}
                 ...
                 />{" "}
                <span className="text-[#84828A]">Patient Management</span> 
               </NavLink>
               <NavLink
              ...
              >
                ...
                />{" "}
               <span className="text-[#84828A]">Appointments</span> 
              </NavLink>
              <NavLink
                to={"/DoctorsPayments"}
                className={({ isActive }) =>
              ...
              >
                ...
                />{" "}
               <span className="text-[#84828A]"> Payment Status</span>
              </NavLink>
              <NavLink
                to={"/DoctorsSupport"}
                className={({ isActive }) =>

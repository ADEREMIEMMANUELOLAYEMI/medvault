...
export default function Healthcare() {
  return (
    <div className='bg-[#EAE9FB] min-h-screen lg:min-h-[756px] flex flex-col items-center font-sans'>
      {/* Services Section */}
      <section className='w-full max-w-6xl px-4 sm:px-6 py-8 sm:py-12 text-center'>
        <h2 className='text-[24px] sm:text-[28px] md:text-[36px] inter font-medium mb-4 leading-tight text-[#000] max-w-3xl mx-auto'>
          Our Services
        </h2>

        <p className='text-[#2E2E2E] max-w-2xl mx-auto text-sm sm:text-base'>
          <span className='inter'>
            Connecting every hospital and patient with one secure ID — making
            healthcare seamless,
          </span>
        ...
        <div className='grid gap-6 sm:gap-8 md:grid-cols-2 lg:grid-cols-3 mt-8 sm:mt-10'>
          {/* Card 1 */}
          <div className='bg-[#F8F8F8] rounded-2xl shadow-md hover:shadow-lg transition p-4 sm:p-6 flex flex-col items-center w-full max-w-sm mx-auto'>
            <img
              src={Office}
              alt='Medical Staff Tools'
              className='rounded-[8px] mb-4 w-full h-[150px] sm:h-[200px] object-cover'
            />
            <h3 className='font-medium text-[18px] sm:text-[20px] md:text-[24px] mb-[12px] inter leading-[28px] text-center'>
              Medical Staff Tools
            </h3>
          ...
          {/* Card 3 */}
          <div className='bg-[#F8F8F8] rounded-2xl shadow-md hover:shadow-lg transition p-4 sm:p-6 flex flex-col items-center w-full max-w-sm mx-auto md:col-span-2 lg:col-span-1'>
            <img
              src={Macbook}
              alt='Appointment & Scheduling'
              className='rounded-[8px] mb-4 w-full h-[150px] sm:h-[200px] object-cover'
      ...
      <section className='w-full max-w-6xl px-4 sm:px-6 py-8 sm:py-12 text-center'>
        ...
        <div className='grid md:grid-cols-2 gap-6 sm:gap-8 items-center'>
          {/* Contact Info */}
          <div className='flex flex-col items-center md:items-start space-y-3 sm:space-y-4 text-center md:text-left'>
          ...
          <div className='flex justify-center order-first md:order-last'>
            <img
              src={Grace}
              alt='Contact'
              className='rounded-lg shadow-md max-w-xs sm:max-w-sm w-full h-auto object-cover'
            />
          </div>
        </div>
      </section>

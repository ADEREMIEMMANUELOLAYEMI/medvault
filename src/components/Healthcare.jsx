  ...
  return (
    <div className='bg-[#EAE9FB] min-h-[756px] w-[1440px] flex flex-col items-center font-sans '>
      ...
      <section className='w-full max-w-6xl px-6 py-12 text-center'>
        <h2 className=' text-[36px] inter font-medium mb-4 leading-[42px] text-[#000] w-[963px] h-[64px] items-center justify-center'>
          Our Services
        </h2>
        ...
        <div className='grid md:grid-cols-2 gap-8 items-center'>
          ...
          <div className='flex flex-col items-start space-y-4 text-left'>
            <p className='flex items-center gap-2 text-gray-700'>
              <MapPin className='w-5 h-5 text-red-500' /> Address: [Insert
              Office Address]
            </p>
            <p className='flex items-center gap-2 text-gray-700'>
          ...
          <div className='flex justify-center'>
            <img src={Grace} alt='Contact' className='rounded-lg shadow-md' />
          </div>
        </div>
      </section>
    </div>
